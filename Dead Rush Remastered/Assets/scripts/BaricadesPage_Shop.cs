...
public class BaricadesPage_Shop : ShopWindowPage
{
    ...
    public void ShowBaricades()
    {
        ...
        if (GameCache.cacheContainer.baricadesPlayer.ContainsKey(target_baricades.name_prefab))
        {
        ...
        {
            btn_buy.interactable = GameCache.cacheContainer.money >= baricadesList[selected_index].sale;
    ...
    public void OnActionBaricades()
    {
        switch (actionType)
        {
            case PageActionType.Select:
                GameCache.cacheContainer.baricades = baricadesList[selected_index];
                break;
            case PageActionType.Buy:
                GameCache.cacheContainer.baricadesPlayer.Add(baricadesList[selected_index].name_prefab, baricadesList[selected_index]);
                GameCache.cacheContainer.money -= baricadesList[selected_index].sale;
                CallBuyEvent();
                break;
        }
